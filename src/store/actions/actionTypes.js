...
export const FETCH_OTHER_USER_REQUEST = 'FETCH_OTHER_USER_REQUEST';

export const FETCH_SPECIFIC_JOB_REQUEST = 'FETCH_SPECIFIC_JOB_REQUEST';
export const FETCH_SPECIFIC_JOB_SUCCESS = 'FETCH_SPECIFIC_JOB_SUCCESS';
export const FETCH_SPECIFIC_JOB_FAIL = 'FETCH_SPECIFIC_JOB_FAIL';
